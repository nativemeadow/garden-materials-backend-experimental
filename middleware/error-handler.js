...
/**
 * 
 * credit: https://simonplend.com/how-to-create-an-error-handler-for-your-express-api/
 */
...
function errorHandlerMiddleware(error, request, response, next) {
     ...
     */
    // errorResponse.body = NODE_ENVIRONMENT === "production" ? errorMessage.substring(0, errorMessage.indexOf('\n')) : errorMessage;
